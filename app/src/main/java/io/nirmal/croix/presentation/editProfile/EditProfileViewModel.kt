...
class EditProfileViewModel @Inject constructor(
    ...
    private val _githubTextFieldState = mutableStateOf<StandardTextFieldStates>(StandardTextFieldStates())
    ...
    private val _instagramTextFieldState = mutableStateOf<StandardTextFieldStates>(StandardTextFieldStates())
    ...
    private val _linkedinTextFieldState = mutableStateOf<StandardTextFieldStates>(StandardTextFieldStates())
